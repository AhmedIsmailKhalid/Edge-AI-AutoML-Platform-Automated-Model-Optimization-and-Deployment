"""
Unit tests for TensorFlow PTQ INT4 optimization.
"""
...
def test_ptq_int4_initialization():
    ...
    optimizer = PTQInt4TensorFlow(config={})
...
def test_ptq_int4_count_parameters(sample_model):
    ...
    # Model has: dense1 (10*50 + 50) + dense2 (50*10 + 10) = 1110 parameters
...
def test_ptq_int4_optimize(sample_model, sample_dataset):
    ...
    assert result.metadata["quantization_type"] == "post_training"
