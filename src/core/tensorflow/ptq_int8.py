"""
Post-Training Quantization (INT8) for TensorFlow models.
"""
...
class PTQInt8TensorFlow(BaseOptimization):
    """
    Post-Training Quantization to INT8 for TensorFlow models.
    Uses TFLite converter with INT8 quantization.
    """
    ...
    def requires_dataset(self) -> bool:
        """PTQ INT8 requires representative dataset for calibration."""
        return True
    ...
    def estimate_time(self, model: Any) -> float:
        ...
        # Rough estimate: ~2 seconds per million parameters (conversion overhead)
        return max(5.0, param_count / 500_000)
    ...
    def optimize(
        ...
        """
        Apply INT8 quantization to TensorFlow model using TFLite.
        ...
        result = OptimizationResult(
            ...
            metadata={"quantization_type": "post_training", "dtype": "int8", "format": "tflite"},
